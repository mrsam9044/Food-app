...
import { PARCEL_LOGO, REACT_LOGO, TAILWINDCSS_LOGO } from "../constants";
  ...
  return (
    <div className="min-h-screen w-3/4 flex items-center flex-col pt-28 mb-24">
      ...
      <h2 className=" w-full font-semibold mt-5 text-xl text-wrap p-2  text-gray-800 text-center">
        Food Palace - Reacting to Your Hunger, One Byte at a Time! 🌶️
      </h2>
      ...
      <p className="paragraph">
        Welcome to Food Palace, a culinary haven where cutting-edge technology
      ...
      <p className="paragraph">
        Food Palace is built on a foundation of the latest and most robust
      ...
      <p className="paragraph">
        Food Palace is more than a food delivery platform; it's a culinary
      ...
      <p className="paragraph">
        At Food Palace, we're not just delivering food; we're delivering an
